...
#define ERR_SYS_MEM         -2          /* system allocate memory error     */


#define ERR_MEM             2           /* error occur when use memory      */
#define ERR_PARAM           3           /* invalid parameters               */
#define ERR_STATE           4           /* error found for state machines   */
